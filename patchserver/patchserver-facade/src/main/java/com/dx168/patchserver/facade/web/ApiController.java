...
public class ApiController {
    ...
    public @ResponseBody
    RestResponse patch_info(HttpServletRequest req, String appUid, String token, String versionName, String tag,
        ...
        try {
            ...
            // edit by dyg Note cause useless
...
//            }
    ...
    public @ResponseBody
    RestResponse report(HttpServletRequest req, String appUid, String token, String versionName, String tag, String platform, String osVersion,
    ...
    public @ResponseBody
    RestResponse clearCache() throws Exception {
