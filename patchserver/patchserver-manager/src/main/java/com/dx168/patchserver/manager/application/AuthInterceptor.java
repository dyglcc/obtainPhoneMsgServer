...
//        if(HttpRequestUtils.isInclude(uri,"/api/pass/**")){
//            return super.preHandle(req, res, handler);
//        }else{
//            return true;
//        }

//        boolean isNeedFilter = HttpRequestUtils.isInclude(uri,"/api/**","/api/app/**","/api/patch/**","/api/version/**","/api/tester/**","/api/modelblacklist/**","/api/channel/**","/api/child_user/**","/api/full_update/**");
//
//        if (!isNeedFilter) {
//            return true;
//        }
...
//        }
    ...
    private String getRedirectUrl(HttpServletRequest req) {
        ...
        return "/api/login?redirect=" + redirect;
    }
}
