...
public class ManagerController {
    ...
    public ModelAndView index() {
        return new ModelAndView("redirect:/api/app/list");
    }
    ...
    @RequestMapping(value = "/api/app/create", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/api/app/fill_package", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/api/tester/list", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/api/tester/add", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/api/tester/del", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/api/modelblacklist/list", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/api/modelblacklist/add", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/api/modelblacklist/del", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/api/channel/list", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/api/channel/add", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/api/channel/del", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/api/app/create_version", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/api/app/version", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/api/patch/add", method = RequestMethod.GET)
    public ModelAndView on_patch_add_session_time_out(String appUid, String versionName) {
        return new ModelAndView("redirect:/api/app/version?appUid=" + appUid + "&versionName=" + versionName);
    }

    @RequestMapping(value = "/api/patch/add", method = RequestMethod.POST)
    public ModelAndView patch_create(String appUid, String versionName, String description, @RequestParam("file") MultipartFile multipartFile) {
        ...
        try {
            ...
            restR.setMessage(e.getMessage());
            return new ModelAndView("redirect:/api/app/version?appUid=" + appUid + "&versionName=" + versionName + "&msg=" + HttpRequestUtils.urlEncode(e.getMessage()));
        }
    }

    @RequestMapping(value = "/api/patch/delClient", method = RequestMethod.GET)
    public ModelAndView delteClient(HttpServletRequest req, Integer id, Integer patchId, String appUid) {
        BizAssert.notNull(id, "Item Id不能为空");
        BizAssert.notEpmty(appUid, "应用号不能为空");
        BizAssert.notNull(patchId, "补丁信息id不能为空");

        appService.deleteSingleClient(id);
        return new ModelAndView("redirect:/api/patch?appUid=" + appUid + "&id=" + patchId);
    }

    @RequestMapping(value = "/api/patch/addSingleClient", method = RequestMethod.POST)
    public ModelAndView patch_add_single_client(String appUid, Integer patchId, String clientId) {
        RestResponse restR = new RestResponse();
        try {
            BizAssert.notEpmty(appUid, "应用号不能为空");
            BizAssert.notNull(patchId, "补丁信息id不能为空");
            BizAssert.notNull(clientId, "设备id不能为空");

            ClientsFix clientsFix = new ClientsFix();
            clientsFix.setClientId(clientId);
            clientsFix.setPatchId(patchId);
            appService.saveSingleClientFix(clientsFix);
    ...
    @RequestMapping(value = "/api/patch/importClientFile", method = RequestMethod.POST)
    public ModelAndView patch_create(String appUid, Integer patchId, @RequestParam("file") MultipartFile multipartFile) {
        RestResponse restR = new RestResponse();
        try {
            BizAssert.notEpmty(appUid, "应用号不能为空");
            BizAssert.notNull(patchId, "补丁ID不能为空");
            BizAssert.notNull(multipartFile, "请选择文件");

            appService.saveBatchClients(patchId, multipartFile);
    ...
    @RequestMapping(value = "/api/patch/info", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/api/patch/normal_publish", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/api/patch/stop_publish", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/api/patch/delete", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/api/patch/gray_publish", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/api/full_update", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/api/full_update", method = RequestMethod.POST)
...
//            }
            ...
            return new ModelAndView("redirect:/api/full_update?appUid=" + fullUpdateInfo.getAppUid() + "&optSuccess=true");
        } catch (BizException e) {
            return new ModelAndView("redirect:/api/full_update?appUid=" + fullUpdateInfo.getAppUid() + "&msg=" + HttpRequestUtils.urlEncode(e.getMessage()));
        }
    }
}
